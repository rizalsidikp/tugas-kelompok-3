                                ...
                                <form action="{{ route('users.store') }}" method="POST">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="name" placeholder="Masukkan Nama"
                                            class="form-control" required="required" value="{{ old('name') }}"
                                            class="@error('name') is-invalid @enderror">
                                    </div>
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="password" name="rtype" placeholder="retype password"
                                            class="form-control" required="required"
                                            class="@error('rtype') is-invalid @enderror">
                                    </div>

                                    <<<<<<< HEAD @if ($user->role == 'staff')
                                        <div class="form-group mb-2">
                                        ...
                                        @if ($user->role == 'staff')
                                            ...
                                            <div class="form-group mb-2">
                                                <label>Upload KTP</label>
                                                <input type="file" name="ktp" placeholder="ktp"
                                                    class="form-control" required="required"
